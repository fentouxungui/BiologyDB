...
```{r}
tf.full.database <- read.csv("../inst/extdata/The-Human-Transcription-Factors/DatabaseExtract_v_1.01.csv.gz", stringsAsFactors = FALSE)
...
colnames(results) <- c("Ensembl","Symbol","Entrez","TF.DBD")
```
